...
const storage =
  process.env.DB_STORAGE || path.join(__dirname, "..", "..", "payment.sqlite");
 ...
 * Define your model files here (e.g. payment.js) which export functions that
 * receive a `sequelize` instance and DataTypes and return a model.
 *
 * Example model file (src/models/payment.js):
 * module.exports = (sequelize, DataTypes) => {
 *   return sequelize.define('Payment', { amount: DataTypes.DECIMAL }, {});
 * };
 *
